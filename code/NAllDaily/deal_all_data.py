...
from code.NAllDaily import handle_sql
import tool
...
def select(today, fund_account):
    handle_sql.select(today, fund_account)
    ...
    if config_data:
        for product in config_data['products']:
            ...
            for code in product['codes']:
                ...
                deal_part_data(today, account_local_path, position_local_path, deal_local_path, product_name, name, other_name, fund_account)
...
if __name__ == "__main__":
    ...
    today = '20250527'
    # 定义输入和输出文件路径
    input_file = r'c:\Users\Top\Desktop\ftp\part-result.csv'
    output_file = r'c:\Users\Top\Desktop\ftp\all-result.csv'
