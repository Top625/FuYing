...
def export_data(target_date, output_file):
    """导出指定日期的数据到新表格"""
    input_files = [
        r'c:\Users\Top\Desktop\ftp\part-result.csv',
        r'c:\Users\Top\Desktop\ftp\all-result.csv'
    ]
    all_data = []
    fieldnames = []
    seen_fields = set()
...
if __name__ == "__main__":
    target_date = '20250527'
    # 输出文件路径改为 Excel 格式
    output_file = r'c:\Users\Top\Desktop\ftp\exported_data.xlsx'
