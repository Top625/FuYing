...
def export_data(target_date, output_file):
    """导出指定日期的数据到新表格"""
    input_files = [
        r'c:\Users\Top\Desktop\尊享2号\part-result.csv',
        r'c:\Users\Top\Desktop\尊享2号\all-result.csv'
    ]
    all_data = []
    fieldnames = []
    seen_fields = set()
...
if __name__ == "__main__":
    ...
    name = '山西证券'
    # 输出文件路径改为 Excel 格式
    output_file = rf'c:\Users\Top\Desktop\{name}\exported_data.xlsx'
