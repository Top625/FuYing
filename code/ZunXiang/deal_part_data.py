...
def deal_part_data(today, account_file, position_file, output_file):
   ...
   # 获取申购赎回金额
    # subscription_redemption_path = r'C:\Users\Top\Desktop\尊享2号\申购赎回记录.csv'
    # print(account_name, current_date)  # 调试输出 account_name 的值
...
if __name__ == "__main__":
    ...
    account_file = rf'c:\Users\Top\Desktop\{name}\{code_name}-Account-{today}.csv'
    position_file = rf'c:\Users\Top\Desktop\{name}\{code_name}-PositionStatics-{today}.csv'
    output_file = rf'c:\Users\Top\Desktop\{name}\part-result.csv'
