...
if __name__ == "__main__":
    # 请根据实际情况修改以下路径
    # 要压缩的文件路径
    input_file_path = r"C:\Users\Top\Desktop\FuYing\code\BJ.xlsx"
    # 压缩到的文件基础路径，指定分卷文件存储的位置和前缀
    zip_base_path = r"C:\Users\Top\Desktop\FuYing\code\New\BJ.zip"
    # 第一个分卷文件的绝对路径
    first_zip_part = Path(zip_base_path).parent / f"{Path(zip_base_path).name}.001"
    # 解压到的文件路径
    extract_path = r"C:\Users\Top\Desktop\FuYing\code\New"
